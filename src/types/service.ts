...
export type CrudService = AnyRecord & {
  ...
  create(data: AnyRecord): Promise<ServiceResult>;
  update(id: Identifier, data: AnyRecord): Promise<ServiceResult>;
  delete(id: Identifier): Promise<ServiceResult>;
  search(query: string, options?: QueryOptions): Promise<ServiceResult<any[]>>;
  count(query?: AnyRecord): Promise<number>;
  bulkCreate(items?: AnyRecord[]): Promise<AnyRecord>;
  bulkUpdate(updates?: AnyRecord[]): Promise<AnyRecord>;
  bulkDelete(ids?: Identifier[]): Promise<AnyRecord>;
