...
function resolveSchema(entity: string) {
...
function collectErrors(schema: SchemaDefinition, body: AnyRecord, fieldFilter?: string[]) {
...
function respondErrors(res: Response, errors: Record<string, string>) {
